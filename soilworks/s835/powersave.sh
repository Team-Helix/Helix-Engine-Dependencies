...
#pwrutilx gov tweaks
PWRUTIL_UP_RATE_LITTLE='10000'
PWRUTIL_DOWN_RATE_LITTLE='1000'
PWRUTIL_IOWAIT_BOOST_LITTLE='0'
PWRUTIL_UP_RATE_BIG='10000'
PWRUTIL_DOWN_RATE_BIG='1000'
...
TARGET_LOADS_BIG='90 1132800:95'
