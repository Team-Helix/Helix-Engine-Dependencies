		...
		if [ -e $AGL ]; then
			...
			if grep 'blu_active' $AGL; then
				if [ -e $AGL ]; then
					...
					echo 70 672000:76 883200:78 1401600:81 > $LGP/blu_active/target_loads
					...
					echo 0 672000:10000 883200:25000 1401600:50000 > $LGP/blu_active/above_hispeed_delay
				...
				if [ -e $AGL ]; then
					...
					echo 70 672000:76 883200:78 1401600:81 > $LGP/interactive/target_loads
					...
					echo 0 672000:10000 883200:25000 1401600:50000 > $LGP/interactive/above_hispeed_delay
...
if [ -d /sys/devices/system/cpu/cpufreq/policy4 ]; then
	...
	if grep 'schedutil' $AGB; then
		...
		if [ -e $AGB ]; then
			...
			echo 70 652800:76 902400:78 1132800:81 2208000:85 > $BGP/blu_active/target_loads
			...
			echo 0 1132800:50000 2208000:80000 > $BGP/blu_active/above_hispeed_delay
		...
		if [ -e $AGB ]; then
			...
			echo 70 652800:76 902400:78 1132800:81 2208000:85 > $BGP/interactive/target_loads
			...
			echo 0 1132800:50000 2208000:80000 > $BGP/interactive/above_hispeed_delay
...
# if [ -e "/sys/module/wakeup/parameters/enable_wlan_extscan_wl_ws" ]; then 
	# echo Y > /sys/module/wakeup/parameters/enable_wlan_extscan_wl_ws
# fi
# if [ -e "/sys/module/wakeup/parameters/enable_wlan_wow_wl_ws" ]; then 
	# echo Y > /sys/module/wakeup/parameters/enable_wlan_wow_wl_ws
# fi
# if [ -e "/sys/module/wakeup/parameters/enable_wlan_ws" ]; then
	# echo Y > /sys/module/wakeup/parameters/enable_wlan_ws
# fi
# if [ -e "/sys/module/wakeup/parameters/enable_netmgr_wl_ws" ]; then
	# echo Y > /sys/module/wakeup/parameters/enable_netmgr_wl_ws
# fi
...
# if [ -e "/sys/module/wakeup/parameters/enable_wlan_ipa_ws" ]; then
	# echo Y > /sys/module/wakeup/parameters/enable_wlan_ipa_ws
# fi
# if [ -e "/sys/module/wakeup/parameters/enable_wlan_pno_wl_ws" ]; then
	# echo Y > /sys/module/wakeup/parameters/enable_wlan_pno_wl_ws
# fi
...
if [ -e $GPU_FREQ ]; then
	...
	if grep '180000000' $av_freq; then
		...
		echo 596000000 > /sys/devices/soc/5000000.qcom,kgsl-3d0/devfreq/5000000.qcom,kgsl-3d0/target_freq
