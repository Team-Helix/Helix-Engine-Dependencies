...
SCHED_INIT_TASK_LOAD='90'
SCHED_ENABLE_POWER_AWARE='1'
SCHED_ENABLE_THREAD_GROUPING='0'
SCHED_BIG_WAKER_TASK_LOAD='25'
...
SCHED_SELECT_PREV_CPU_US='1000'

#Interactive gov tweaks
TARGET_LOADS_LITTLE='67 422400:49 480000:56 556800:68 652800:76 729600:81 844800:84 960000:89 1036800:87 1111300:84 1190400:7 1228800:86 1324800:92 1478400:99'
...
MIN_SAMPLE_TIME_LITTLE='25000'
MAX_FREQ_HYSTERESIS_LITTLE='79000'
FAST_RAMP_DOWN_LITTLE='0'
USE_SCHED_LOAD_LITTLE='1'
BOOSTPULSE_DURATION_LITTLE='80000'

TARGET_LOADS_BIG='58 556800:58 652800:78 729600:80 806400:84 883200:77 940800:82 1036800:86 1113600:84 1190400:87 1248000:88 1324800:90 1785600:96'
TIMER_SLACK_BIG='90000'
TIMER_RATE_BIG='15000'
HISPEED_FREQ_BIG='${BIG_MAX_VALUE}'
ABOVE_HISPEED_DELAY_BIG='0'
GO_HISPEED_LOAD_BIG='400'
MIN_SAMPLE_TIME_BIG='25000'
...
INPUT_BOOST_FREQ='0:1228000 1:0 2:0 3:0'
INPUT_BOOST_MS='1000'
...
IO_tweaks() {
	...
	if [[ -d ${Q_PATH} ]]; then
		if grep 'bfq' ${Q_PATH}/scheduler; then
			echo "bfq" > ${Q_PATH}/scheduler
		elif grep 'deadline' ${Q_PATH}/scheduler; then
			echo "deadline" > ${Q_PATH}/scheduler
